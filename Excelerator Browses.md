...
- Development
- Support
description: Overview Browses help data entry by displaying cross referenced data
  for the range on the sheet currently selected. They allow the user to select…
created: '2021-04-26'
modified: '2021-09-27'
