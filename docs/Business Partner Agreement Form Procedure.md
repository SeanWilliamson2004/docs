---
title: Business Partner Agreement Form Procedure
tags:
- Sales
description: Download the BP Agreement Form Go onto the Codis Sales Home page and
  download and open the Codis Reseller Agreement on Microsoft Word. Select the…
created: '2018-02-22'
modified: '2018-06-01'
original_url: https://codislimited.sharepoint.com/sites/Wiki/Pages/Business%20Partner%20Agreement%20Form%20Procedure.aspx
---
...
On **page 2**, ensure the the day's date is correct. Further down the page simply type the company's full name and address. 

The 'Registered Number' also known as the company registration number is an important part of the agreement form. 

You can find the company registration number on this link. [http://wck2\.companieshouse.gov.uk//wcframe?name\=accessCompanyInfo](http://wck2.companieshouse.gov.uk//wcframe?name=accessCompanyInfo) 

Ensure the company address on the CRM account matches the address on the above Companies House website. If the addresses are not the same then you may risk providing the wrong company registration number. 
...
Once you have finished making the changed to the agreement form, double check the changes you have made to make sure they are accurate. 

Send the copy of the to the relevant person via email. 
...
1\. Mohan to sign both copies.

2\. Post one copy back to the Business Partner.
...
Go to the company's CRM account, then onto 'People' and select the relevant person to send the email to.

The email template you should select is 'BBB BP On Board'. 
...
This second email can be typed up using your own words. The below email in the screenshot is just an example that can be used to be sent to the Business Partner.

In the email, you can include a thank you message, a short welcome on board line , reference to the marketing materials, and scheduling training.

Add the name of the receipient, CC Cormac and add the subject in the subject line.

Press send once you have finished writing up the email.

![](images/Sales_Sales_Wiki_Images_Business_Partner_Agreement_Form_Procedure_BP_Agreement_Form_Screenshot_8.PNG)
