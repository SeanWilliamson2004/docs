---
title: Creation of Sage X3 GL Accounts
tags:
- Sage X3
description: A Sage X3 GL Account is an account or record used to sort and store balance
  sheet and income statement transactions. Examples of general ledger…
created: '2017-01-25'
modified: '2017-01-27'
original_url: https://codislimited.sharepoint.com/sites/Wiki/Pages/Creation%20of%20Sage%20X3%20GL%20Accounts.aspx
---

A [Sage X3](http://intranet/wiki/4051/sage-x3) GL Account is an account or record used to sort and store balance sheet and income statement transactions. Examples of general ledger accounts include the asset accounts such as Cash, Accounts Receivable, Inventory, Investments, Land, and Equipment. Examples of the general ledger liability. 

## Creation

To create GL Accounts, the below are the pre\-requisites: 

1. Company \& Sites setup
2. Chart of Accounts, Ledger \& Account Core model
...
This field recalls the chart of accounts on which the account (general, analytical, both) will be created or to which they will be attached. Before creating an account, the attachment chart of accounts needs to be specified using the Chart button. 

### Account

Account number that is used to identify it in the chart of accounts. The codification of the account depends on the format and length options applied during the setup of the chart of accounts. If the account numbering with fixed length option is retained, the account numbers entered will automatically be completed with "0"s up to the length defined in the setup. 
...
![](images/Support_Support_Wiki_Images_Sage_X3_Image_12.png) 
...
![](images/Support_Support_Wiki_Images_Sage_X3_Image_13.png) 
...
![](images/Support_Support_Wiki_Images_Sage_X3_Image_14.png) 
...
![](images/Support_Support_Wiki_Images_Sage_X3_Image_15.png) 
