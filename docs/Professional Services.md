...
- CRM
- Workflow
description: Procedure For Professional Services This page describes how professional
  services manage jobs from the Initial CRM case to sign off. Workflow…
created: '2017-01-27'
modified: '2024-09-24'
original_url: https://codislimited.sharepoint.com/sites/Wiki/Pages/Professional%20Services.aspx
---

**Procedure For Professional Services**   
This page describes how professional services manage jobs from the Initial CRM case to sign off. 

## **Workflow**

Professional services use the CRM for top level control of projects. Once a customer signs off the PO sales will create a case a consultancy case in CRM. This case will then pass through various stages until sign off is complete.
...
Contact information is confirmed for both the end user and the Business Partner (BP) when necessary. 

The Pre\-Requisite document details the requirement from the customer site before starting. 

Normally, the Pre\-Requisite document is sent to the client who enters the details and emails back to Codis. 

The Pre\-Requisite document should be saved against the consultancy case.
...
Once the signed or approved Activity Report has been received, the consultany case will be moved to this stage by sales so that the customer can be invoiced.
