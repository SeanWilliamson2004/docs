...
- IT
- Security
description: 'Program Objectives The objectives of this Information Security Program
  ("Program") are as follows: Ensure the security and confidentiality of Codis''s…'
created: '2022-05-06'
modified: '2022-05-06'
original_url: https://codislimited.sharepoint.com/sites/Wiki/Pages/Information%20Security%20Program.aspx
---
...
- Ensure the security and confidentiality of Codis's customer information.
- Protect against any anticipated threats or hazards to the security and/or integrity of Codis's customer information.
- Protect against unauthorized access to or use of Codis's customer information that could result in substantial harm or inconvenience to any customer.

For purposes of the Program, "customer information" means any information about a customer of Codis, or information Codis receives about the customer of another financial institution, that can be directly or indirectly attributed to the customer. This Program, in and of itself, does not create a contract between Codis and any person or entity.
...
The Program Coordinator shall revaluate and modify the Program from time to time as the Program Coordinator deems appropriate. The Program Coordinator shall base such revaluation and modification on the following:

- The results of the Program Coordinator's testing and monitoring efforts.
- Any material changes to Codis's operations, business or information technology arrangements.
...
In keeping with the objectives of the Program, Codis shall implement, maintain and enforce the following employee management and training safeguards:

1\.       All employees and independent contractors are responsible for complying with Codis's Program.

2\.       Codis will check references of each potential employee prior to the commencement of the applicant's employment.

3\.       Codis will obtain a consumer report and criminal background check of each applicant prior to the commencement of the applicant's employment.

4\.       All offers of employment shall be subject to satisfactory references and consumer/criminal report investigations.

5\.       All new employees, and independent contractors who perform services in Codis, that have access to customer information will participate in Codis's information security training. Each person shall sign and acknowledge his or her agreement to abide by Codis's Program. Training will recur at least once each year, or sooner, as determined by Codis management and as required by changes to the Program.
...
7\.       Codis will take appropriate steps to encourage awareness of, and compliance with the Program.

8\.       All employees and independent contractors will be permitted to access customer information on a "need\-to\-know" basis as determined by Codis management.

9\.       Personnel shall not be permitted to access, use or reproduce customer information, whether electronic or non\-electronic, for their own use or for any use not authorized by Codis.

10\.     All persons who fail to comply with Codis's Program shall be subject to disciplinary measures, up to and including termination of employment for employees or contract termination for independent contractors that perform services with Codis. This remedy shall be expressly provided for in Dealer's contracts and agreements with such independent contractors.

# [Information Security Policies and Procedures – Information Systems](https://codislimited.sharepoint.com/sites/Wiki/General/General%20Wiki/Documents/Templates/codis_communications_and%20systems_policy_version_1.1.docx)

In keeping with the objectives of the Program, Codis shall implement, maintain and enforce the following information systems safeguards:
...
- Inbound credit card information, credit applications, or other sensitive financial data transmitted to Codis directly from consumers shall use a secure connection, such as a Secure Sockets Layer (SSL) or other currently accepted standard, so that the security of such information is protected in transit. Such secure transmissions shall be automatic. Consumers shall be advised against transmitting sensitive data, like account numbers, via electronic mail.
- Codis shall require by contract that inbound transmissions of customer information delivered to Codis via other sources be encrypted or otherwise secured.
- All outbound transmissions of customer information shall be secured in a manner acceptable to the Program Coordinator.
- To the extent sensitive data must be transmitted to Codis by electronic mail, such transmissions shall be password controlled or otherwise protected from theft or unauthorized access at the discretion of the Program Coordinator.
- The Program Coordinator shall review all vendor applications to ensure an appropriate level of security both within Codis and with Codis's business partner and vendors.

3\.       All paper transmissions of customer information by Codis shall be performed on a secure basis.

- Sensitive customer information shall be properly always secured.
- Customer information delivered by Codis to third parties shall be kept always sealed.
...
5\.       The Program Coordinator shall maintain an inventory of Codis computers, including any handheld devices or PDAs, on or through which customer information may be stored, accessed or transmitted.
