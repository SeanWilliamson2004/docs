...
title: ALM - Bugs
tags: []
description: A bug is a defect found in the software, where the software fails to
  work as is expected. There is a section in this document that describes the role…
created: '2020-06-08'
modified: '2020-06-08'
original_url: https://codislimited.sharepoint.com/sites/Wiki/Pages/ALM%20-%20Bugs.aspx
---
...
3. The Product Group and Product Name.  If the product is not available in the list, please approximate as best you can.
4. The CRM case number (if there is one).

Note that discussion around the bug can take place below.  Note that if discussion are recorded here rather than in teams, then the details are readily available for anybody to see.
